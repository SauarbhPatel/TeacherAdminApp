...
export default function HomeworkDashboardScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      fetchData(data?.length > 0 ? true : false);
    }, [fetchData]),
  );
  const onRefresh = () => {
    setRefreshing(true);
  ...
  const { totalHwTotal, totalHwFilled, totalHwPending } = useMemo(() => {
    ...
    return {
      totalHwTotal: total,
      totalHwFilled: filled,
      totalHwPending: total - filled,
    };
  }, [data]);
      ...
      >
        ...
        {!loading && (
          <View style={styles.summaryRow}>
            ...
            <View style={styles.summaryPill}>
              <Text style={[styles.sumNum, { color: "#fca5a5" }]}>
                {totalHwPending}
              </Text>
        ...
        <View style={styles.statusBar}>
          <View style={styles.statusItem}>
            ...
            <Text style={styles.statusTxt}>
              {totalHwFilled} subjects filled
            </Text>
          </View>
          <View style={styles.statusItem}>
            <View
              style={[styles.statusDot, { backgroundColor: Colors.amber }]}
            />
            ...
            <>
              ...
              {classGroups.length === 0 ? (
                <View style={styles.center}>
                  ...
                  <Text style={{ color: Colors.text3 }}>No classes found</Text>
                </View>
              ) : (
                classGroups.map((cls, i) => {
                  ...
                  const filledHw = cls.sections.reduce(
                    (sum, s) =>
                      sum + s.homework.filter((h) => h.description).length,
                    0,
                  );
                  ...
                  return (
                    <TouchableOpacity
                      key={cls.class_id}
                      style={[styles.classCard, { borderLeftColor: accent }]}
                    ...
                    >
                      ...
                      >
                        <Text
                          style={[styles.classLetter, { color: accent }]}
                          numberOfLines={1}
                      ...
                      >
                        <Text style={[styles.hwBadgeTxt, { color: accent }]}>
                          {filledHw}/{totalHw}
                        </Text>
                        <Text style={[styles.hwBadgeLbl, { color: accent }]}>
                          filled
                        </Text>
                      </View>
            ...
            <>
              ...
              {selClass.sections.map((item, i) => {
                ...
                return (
                  <TouchableOpacity
                    key={item.section_id}
                    style={[styles.sectionCard, { borderLeftColor: accent }]}
                  ...
                  >
                    ...
                    >
                      <Text
                        style={[styles.secLetter, { color: accent }]}
                        numberOfLines={1}
                        adjustsFontSizeToFit
                      >
                        {item.section_name}
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <ScrollView
                        horizontal
                        showsHorizontalScrollIndicator={false}
                        contentContainerStyle={{ gap: 4, marginTop: 5 }}
                      >
                        {item.homework.map((hw) => (
                          <View
                            ...
                            style={[
                              styles.subjectPill,
                              {
                                backgroundColor: hw.description
                                  ? Colors.greenBg
                                  : Colors.surface,
                                borderColor: hw.description
                                  ? Colors.green + "60"
                                  : Colors.border,
                              },
                            ]}
