/**
 * exam-remarks-entry.tsx
 *
 * 3-step selector for Exam Remarks:
 *   Step 1 → Select Class
 *   Step 2 → Select Section
 *   Step 3 → Select Exam
 * Then navigates to exam-remarks-students screen.
 * Amber accent colour to differentiate from Attendance (blue).
 */
...
const pill = StyleSheet.create({
    ...
    val: { fontSize: 12, fontWeight: "700", color: Colors.amberText },
...
export default function ExamRemarksEntryScreen() {
    ...
    const loadExams = useCallback(
        async (class_id: string, section_id: string) => {
            ...
            try {
                ...
                if (res.response_code === 200) setExams(res.exams ?? []);
                else
                    setExmError(
                        res?.message ||
    ...
    const pickExam = (exam: ExamItem) => {
        router.push({
            pathname: "/screens/exam-remarks-students" as any,
            params: {
        ...
        <View style={{ flex: 1, backgroundColor: Colors.surface }}>
            ...
            >
                ...
                <View style={styles.headerTop}>
                    ...
                    <View style={{ flex: 1 }}>
                        <Text style={styles.title}>Exam Remarks</Text>
                        <Text style={styles.sub}>
                            Add teacher feedback for students
                        </Text>
                    </View>
                </View>
                ...
                {step === 1 && (
                    <>
                        ...
                        <Text style={styles.stepSub}>
                            Choose the class for remarks entry
                        </Text>
                        {clsLoading ? (
