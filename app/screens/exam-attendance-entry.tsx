/**
 * exam-attendance-entry.tsx
 *
 * 3-step selector for Exam Attendance:
 ...
 * Then navigates to exam-attendance-students screen.
 */
...
// ─── Step indicator (identical pattern to coscholastic-entry) ──
...
const pill = StyleSheet.create({
    ...
    val: { fontSize: 12, fontWeight: "700", color: Colors.blue },
...
export default function ExamAttendanceEntryScreen() {
    ...
    const pickExam = (exam: ExamItem) => {
        router.push({
            pathname: "/screens/exam-attendance-students" as any,
            params: {
                ...
                {step === 1 && (
                    <>
                        ...
                        <Text style={styles.stepSub}>
                            Choose the class for attendance entry
                        </Text>
                        {clsLoading ? (
